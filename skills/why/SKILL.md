...
- Include "Review only. Do not edit files." in the prompt. Investigators may use available MCP tools to gather evidence.
...
- Include "Review only. Do not edit files." in the prompt. The synthesizer may use available MCP tools to spot-verify citations.
