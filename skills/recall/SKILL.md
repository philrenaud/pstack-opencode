...
Session history comes from the host's transcripts, located per the runtime reference (`skills/poteto-mode/references/runtime.md`). Stay within the current project's sessions.
